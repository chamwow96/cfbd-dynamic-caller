# Dynamic Call V9: Added dropdown multiselection functions for Years and Teams
...
# Page configuration
st.set_page_config(page_title="CFBD API Dynamic Caller V9", layout="wide")
...
# Streamlit UI
st.title("🏈 CFBD Dynamic API Caller V9")
...
with col2:
    ...
    if use_multi_year:
        ...
        # Example start year is 2000, change as needed
